    ...
    <div style={containerStyle}>
      <div style={filterContainerStyle}>
        <div style={buttonGroupStyle}>
          <button style={buttonStyle}>All Rooms</button>
          <button style={buttonStyle}>Single</button>
          <button style={buttonStyle}>Double</button>
          <button style={buttonStyle}>Triple</button>
          <button style={buttonStyle}>VIP</button>
        </div>
        ...
        <div style={guestInputContainerStyle}>
          <div style={guestInputStyle}>
            <label>Adult</label>
            <button onClick={() => handleGuestChange({ target: { name: "adults", value: Math.max(availability.adults - 1, 0) } })}>-</button>
            <input type="text" name="adults" value={availability.adults} readOnly />
            <button onClick={() => handleGuestChange({ target: { name: "adults", value: availability.adults + 1 } })}>+</button>
          </div>
          <div style={guestInputStyle}>
            <label>Children</label>
            <button onClick={() => handleGuestChange({ target: { name: "children", value: Math.max(availability.children - 1, 0) } })}>-</button>
            <input type="text" name="children" value={availability.children} readOnly />
            <button onClick={() => handleGuestChange({ target: { name: "children", value: availability.children + 1 } })}>+</button>
          </div>
        </div>
        <button style={addCustomerButtonStyle} onClick={fetchRooms}>Check Availability</button>
      </div>
